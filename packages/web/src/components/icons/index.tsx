import BiChevronLeft from "~/components/icons/BiChevronLeft";
...
import BiMoon from "~/components/icons/BiMoon";
import FaSolidFaucet from "~/components/icons/FaSolidFaucet";

export { BiChevronLeft, BiArrowToTop, BiSun, BiMoon, BiSearch, FaSolidFaucet };
